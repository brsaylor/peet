...
// Ben Saylor 2007-11-26 - modified to work also with <textarea>
// Ben Saylor 2008-09-23 - modified to work also with <select>
...
(function() { // Do everything in this one anonymous function
    ...
    function init() {
		...
		// AND textareas (BRS) AND select elements (BRS)
    ...
    function validateOnChange() {
        ...
        if (this.type == "select-one") {
        	...
        	value = this.value;                          // the user's input
        }
    ...
    function validateOnSubmit() {
        ...
        for(var i = 0; i < this.elements.length; i++) {
            ...
            // OR if element is a textarea or select element
            if ((e.type == "text" || e.type=="textarea" || e.type=="select-one") && e.onchange == validateOnChange) {
