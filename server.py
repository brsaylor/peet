...
class MainWindow(wx.Frame):
    ...
    def onConnectClicked(self, event):
        ...
        if not ((self.params['gametype'] + 'Control')\
                in server.gamecontrollers.__all__):
    ...
    def onStartClicked(self, event):
        ...
        moduleName = 'server.gamecontrollers.' + className
...
app = wx.PySimpleApp()
frame = MainWindow(None, -1, "Experiment Server")
app.MainLoop()
